...
/// Provider responsible for managing the state of the seach filters.
final class SearchFilterNotifierProvider extends $NotifierProvider<SearchFilterNotifier, SearchFilter> {
  /// Provider responsible for managing the state of the seach filters.
  ...
  Override overrideWithValue(SearchFilter value) {
    return $ProviderOverride(origin: this, providerOverride: $SyncValueProvider<SearchFilter>(value));
  }
}

String _$searchFilterNotifierHash() => r'8e1d4d50668d29215c8b7e1932b91cfc57952078';
...
abstract class _$SearchFilterNotifier extends $Notifier<SearchFilter> {
  ...
  void runBuild() {
    ...
    final element =
        ref.element as $ClassProviderElement<AnyNotifier<SearchFilter, SearchFilter>, SearchFilter, Object?, Object?>;
